...
/**
  ...
  Please read the object definition in ha_honuxdb.h before reading the rest
  of this file.
  ...
  @code
  ha_honuxdb::store_lock
  ha_honuxdb::external_lock
  ha_honuxdb::info
  ha_honuxdb::rnd_init
  ha_honuxdb::extra
  ha_honuxdb::rnd_next
...
static handler *honuxdb_create_handler(handlerton *hton, TABLE_SHARE *table,
...
static handler *honuxdb_create_handler(handlerton *hton, TABLE_SHARE *table,
  ...
  return new (mem_root) ha_honuxdb(hton, table);
}
...
int ha_honuxdb::open(const char *, int, uint, const dd::Table *) {
  DBUG_TRACE;
...
int ha_honuxdb::write_row(uchar *) {
  DBUG_TRACE;
  /*
...
*/
int ha_honuxdb::update_row(const uchar *, uchar *) {
  DBUG_TRACE;
...
int ha_honuxdb::delete_row(const uchar *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
int ha_honuxdb::index_read_map(uchar *, const uchar *, key_part_map,
...
int ha_honuxdb::index_next(uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
int ha_honuxdb::index_prev(uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
*/
int ha_honuxdb::index_first(uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
/**
  ...
  opt_range.cc, opt_sum.cc, sql_handler.cc and sql_select.cc
*/
int ha_honuxdb::index_last(uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
/**
  ...
  sql_update.cc
*/
int ha_honuxdb::rnd_init(bool) {
  DBUG_TRACE;
  return 0;
}

int ha_honuxdb::rnd_end() {
  DBUG_TRACE;
  return 0;
}
...
*/
void ha_honuxdb::position(const uchar *) { DBUG_TRACE; }
...
*/
int ha_honuxdb::rnd_pos(uchar *, uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
/**
  ...
  ha_innodb.cc
*/
int ha_honuxdb::extra(enum ha_extra_function) {
  DBUG_TRACE;
  return 0;
}
...
*/
int ha_honuxdb::delete_all_rows() {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
*/
int ha_honuxdb::external_lock(THD *, int) {
  DBUG_TRACE;
  return 0;
}
...
*/
THR_LOCK_DATA **ha_honuxdb::store_lock(THD *, THR_LOCK_DATA **to,
...
*/
int ha_honuxdb::delete_table(const char *, const dd::Table *) {
  DBUG_TRACE;
...
*/
int ha_honuxdb::rename_table(const char *, const char *, const dd::Table *,
                             dd::Table *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
*/
ha_rows ha_honuxdb::records_in_range(uint, key_range *, key_range *) {
  DBUG_TRACE;
...
int ha_honuxdb::create(const char *name, TABLE *, HA_CREATE_INFO *,
                       dd::Table *) {
  DBUG_TRACE;
  /*
